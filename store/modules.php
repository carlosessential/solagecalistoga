...
?>
                ...
                <td class="dataTableContent"><?php if(strstr($module->code,'paypal')){echo 'PayPal';}elseif(strstr($module->code,'shift4')){echo 'Shift4';}else{echo $module->code;}?></td>
    ...
    case 'edit':
      ...
      while (list($key, $value) = each($mInfo->keys)) {
        ...
        if ($value['set_function']) {
		  ...
		  //$keys .= zen_draw_input_field('configuration[' . $key . ']', $value['value'], 'size="50"');
        }
        $keys .= '<br><br>';
      }
