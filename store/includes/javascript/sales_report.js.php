  ...
  function set_sort_options(detail_level) {
    ...
    switch (detail_level) {
      ...
      case 'matrix':
        ...
        hide('order_total_validation_checkbox');
      break;
      case 'product':
        show('div_li_table_a');
        show('div_li_table_b');
      ...
      case 'order':
        show('div_li_table_a');
        show('div_li_table_b');
        show('order_total_validation_checkbox');
      break;
    }
  }
...
///////////////
  function build_select(view, sort_box) {
    ...
    if (view == 'order') {
	  ...
	  sort_box.options[sort_box.options.length] = new Option('<?php echo TABLE_HEADING_ORDER_CARD_TYPE; ?>', 'cc_type');
    }
