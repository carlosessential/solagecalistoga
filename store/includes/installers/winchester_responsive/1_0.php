...
('Version', 'WINCHESTER_RESPONSIVE_VERSION', '1.4', 'Version installed:', " . $configuration_group_id . ", 0, NOW(), NOW(), NULL, NULL),
('Home Page Slideshow', 'WIN_SLIDER_STATUS', 'true', 'Activate Home Page Slideshow', " . $configuration_group_id . ", 1, NOW(), NOW(),NULL,'zen_cfg_select_option(array(\'true\', \'false\'),'), 
...
$messageStack->add('Installed Winchester Responsive Template v1.4', 'success');
