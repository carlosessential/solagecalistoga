...
// order line items: 'oID', 'last_name', 'num_products', 'goods', 'shipping', 'discount', 'gc_sold', 'gc_used', 'grand', 'cc_type'
...
define('TABLE_HEADING_ORDER_CARD_TYPE', 'Card Type');
...
define('MATRIX_TOTAL_CC_ORDERS', 'Orders');
define('MATRIX_TOTAL_CC_SUBTOTAL', 'Subtotal');
...
define('TABLE_HEADING_ORDER_SHIFT4_INVOICE', 'Shift4 Invoice');
define('TABLE_HEADING_ORDER_CARD_NUMBER', 'Card #');
?>
