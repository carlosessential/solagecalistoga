...
// Function to read in text area in admin
 function zen_cfg_textarea_small($text, $key = '') {
  ...
  function zen_cfg_password_input_no_autocomplete($value, $key = '') {
	$field = zen_draw_input_field('configuration[' . $key . ']', $value, 'maxlength="40" autocomplete="off"', $required, 'password', false);
