...
<table border="0" width="100%" cellspacing="2" cellpadding="2">
  <tr>
    ...
    <td class="pageHeading" align="right"><?php echo zen_draw_separator('pixel_trans.gif', HEADING_IMAGE_WIDTH, HEADING_IMAGE_HEIGHT); ?><a href="http://dollarsonthenet.net" target="_blank">DOLLARS ON THE NET Login</a></td>
  </tr>
      ...
      <tr>
        <td valign="top">
          ...
          <table border="0" cellspacing="0" cellpadding="2" width="170" id="tbl_date_custom" style="display:none">
            ...
            <tr>
              <td class="smallText"><?php echo SEARCH_START_DATE ?><br /><script language="javascript">
                StartDate.writeControl(); StartDate.dateFormat="<?php echo DATE_FORMAT_SPIFFYCAL; ?>";</script>
              </td>
            </tr>
            <tr>
              <td class="smallText"><?php echo SEARCH_END_DATE; ?><br /><script language="javascript">
  ...
  <tr>
    ...
    <table border="0" width="100%" cellspacing="0" cellpadding="2">
      <tr>
        ...
        <td align="right" valign="bottom" class="smallText"><span id="order_total_validation_checkbox" style="<?php if ($sr->detail_level != 'order') { echo 'display:none'; } ?>"><?php echo zen_draw_checkbox_field('order_total_validation', '1', false) . 'Output Order Total Validation Column'; ?></span><p></p></td>
...
?>
      ...
      <tr class="totalHeadingRow">
        ...
        <td class="totalHeadingContent" align="left"><?php echo TABLE_HEADING_NUM_ORDERS; ?></td>
        <td class="totalHeadingContent" align="center" colspan="2"><?php echo TABLE_HEADING_NUM_PRODUCTS; ?></td>
		<td class="totalHeadingContent" align="center"></td>
		<td class="totalHeadingContent" align="center"></td>
		<td class="totalHeadingContent" align="center"></td>
        <td class="totalHeadingContent" align="right"><?php echo TABLE_HEADING_TOTAL_GOODS; ?></td>
        <?php if ($display_tax) { ?>
...
?>
      <tr class="totalRow" <?php echo $rollover; ?>>
		...
		<td class="totalContent" align="center"></td>
		<td class="totalContent" align="center"></td>	
		<td class="totalContent" align="center"></td>	
...
?>
      ...
      <tr class="lineItemHeadingRow">
		...
		<td class="lineItemHeadingContent" align="center"><?php echo TABLE_HEADING_ORDER_SHIFT4_INVOICE; ?></td>
		<td class="lineItemHeadingContent" align="center"><?php echo TABLE_HEADING_ORDER_CARD_NUMBER; ?></td>
		<td class="lineItemHeadingContent" align="center"><?php echo TABLE_HEADING_ORDER_CARD_TYPE . show_arrow('cc_type'); ?></td>
...
?>
      <tr class="lineItemRow" <?php echo $rollover; ?> onclick="document.location.href=<?php echo '\'' . zen_href_link(FILENAME_ORDERS, 'oID=' . $o_data['oID'] . '&action=edit', 'NONSSL') . '\''; ?>">
        ...
        <td class="lineItemContent" align="center"><?php echo $o_data['shift4_invoice']; ?></td>
		<td class="lineItemContent" align="center"><?php echo $o_data['shift4_unique_id']; ?></td>
		<td class="lineItemContent" align="center"><?php echo $o_data['cc_type']; ?></td>
      ...
      <tr class="lineItemRow">
        <td colspan="<?php echo $colspan; ?>"><table border="0" width="100%" cellspacing="0" cellpadding="2">
          <tr class="lineItemRow">
            ...
            <td valign="top"><table id="card_type">
              <tr>
                <td class="lineItemContent"><strong><?php echo MATRIX_TOTAL_CC; ?></strong></td>
				<td class="lineItemContent"><strong><?php echo MATRIX_TOTAL_CC_SUBTOTAL; ?></strong></td>
				<td class="lineItemContent"><strong><?php echo MATRIX_TOTAL_CC_ORDERS; ?></strong></td>
              </tr>
              <?php foreach($timeframe['matrix']['credit_cards'] as $key => $cc) { ?>
              <tr>
                <td class="lineItemContent"><?php echo $cc['type']; ?></td>
          		<td class="lineItemContent" align="right"><?php echo '$' . $timeframe['matrix']['card_type_subtotals'][$cc['type']]; ?></td>
				<td class="lineItemContent" align="center"><?php echo $cc['count']; ?></td>
              </tr>
              <?php } ?>
            </table></td>
            <td valign="top"><table border="0" cellspacing="0" cellpadding="2">
...
<?php
if ($start_date && $end_date && (!$payment_method || strToLower($payment_method) == 'shift4')) {
	global $db;

	$timeout_start_date = DateTime::createFromFormat('m/d/Y', $start_date)->format('Y-m-d') . ' 00:00:00';
	$timeout_end_date = DateTime::createFromFormat('m/d/Y', $end_date)->format('Y-m-d') . ' 23:59:59';
	...
	$timeouts = $db->Execute("
							...
							WHERE shift4_timeout_log_time BETWEEN '" . $timeout_start_date . "' AND '" . $timeout_end_date . "'
							");
	$total = $db->Execute("
						SELECT SUM(shift4_timeout_log_amount) as total 
						FROM shift4_timeout_log 
						WHERE shift4_timeout_log_time BETWEEN '" . $timeout_start_date . "' AND '" . $timeout_end_date . "'");

	if ($timeouts->RecordCount() > 0) {
?>
<table border="0" width="60%" cellspacing="0" cellpadding="2" style="margin: 5px;">
	<tbody>
		<tr>
			<td><?php echo "<h1>Shift4 Order Timeouts</h1>";?></td>
		</tr>
		<tr class="lineItemHeadingRow">
			<td class="lineItemHeadingContent">Date</td>
			<td class="lineItemHeadingContent">Customer</td>
			<td class="lineItemHeadingContent" align="center">Shift4 Invoice</td>		
			<td class="lineItemHeadingContent" align="center">Card #</td>
			<td class="lineItemHeadingContent" align="center">Card Type</td>
			<td class="lineItemHeadingContent" align="right">Order Total</td>
		</tr>		
<?php while (!$timeouts->EOF) { ?>
		<tr class="lineItemRow">
			<td class="lineItemContent" align="left"><?php echo DateTime::createFromFormat('Y-m-d H:i:s', $timeouts->fields['shift4_timeout_log_time'])->format('n-j-Y g:i a'); ?></td>
			<td class="lineItemContent" align="left"><?php echo $timeouts->fields['shift4_timeout_log_customer_name']; ?></td>	
			<td class="lineItemContent" align="center"><?php echo $timeouts->fields['shift4_timeout_log_invoice']; ?></td>
			<td class="lineItemContent" align="center"><?php echo $timeouts->fields['shift4_timeout_log_cardnumber']; ?></td>
			<td class="lineItemContent" align="center"><?php echo $timeouts->fields['shift4_timeout_log_cardtype']; ?></td>
			<td class="lineItemContent" align="right"><?php echo '$' . $timeouts->fields['shift4_timeout_log_amount']; ?></td>
		</tr>		
<?php 
		$timeouts->MoveNext();
?>
<?php } ?>
		<tr class="totalRow" style="background-color: #00994C; color: white; font-weight: 800;">
			<td>Total</td>
			<td></td>
			<td></td>
			<td></td>
			<td></td>
			<td align="right"><?php echo '$' . $total->fields['total']; ?></td>
		</tr>
	</tbody>
</table>
<?php
