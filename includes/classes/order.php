...
/* END: ADD MY CUSTOM DETAILS */
  ...
  function send_order_email($zf_insert_id, $zf_mode) {
	...
	// These variables are for the Shift4 payment method
	$html_msg['PAYMENT_INVOICE'] = ''; 
	$html_msg['AUTH_CODE'] = '';
	$html_msg['RECEIPT_TEXT'] = '';	
    ...
    if (is_object($GLOBALS[$_SESSION['payment']])) {
	  ...
	  if ($_SESSION['payment'] == 'shift4') {		
		$html_msg['PAYMENT_INVOICE'] = 'Payment Invoice: ' . $_SESSION['shift4_invoice']; 
	    $html_msg['AUTH_CODE'] = 'Authorization Code: ' . $_SESSION['auth_code'];
		$html_msg['RECEIPT_TEXT'] = 'Receipt Text: ' . $_SESSION['receipt_text'];
		$email_order .= $html_msg['PAYMENT_INVOICE']. "\n";
		$email_order .= $html_msg['AUTH_CODE']. "\n";
		$email_order .= $html_msg['RECEIPT_TEXT']. "\n";
	  } else {
		$email_order .= "\n";
	  }
