 ...
 * Modified by Anne (Picaflor-Azul.com) Winchester Responsive v1.4
 */

define('NAVBAR_TITLE_1', 'Checkout - Step 1 of 4');
define('NAVBAR_TITLE_2', 'Shipping');

define('HEADING_TITLE', 'Step 1 of 4 - Shipping');
